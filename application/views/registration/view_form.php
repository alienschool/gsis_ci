                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <div class="input-icon right">
                                                                                    <i class="fa"></i>
                                                                                    <select class="form-control" data-rule-required="true" id="nationality" name="nationality" required>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <div class="input-icon right">
                                                                                    <i class="fa"></i>
                                                                                    <input type="email" data-rule-required="true" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  name="email" class="form-control" placeholder="" value="">
                                                                                </div>
                                                                                <div class="help-block">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <div class="input-icon right">
                                                                                    <i class="fa"></i>
                                                                                    <input type="text" minlength="11" maxlength="11" id="mobile" data-rule-required="true" name="mobile" data-validation="number" class="form-control" placeholder="" value="">
                                                                                </div>
                                                                                <div class="help-block">
                                                         ...
                                                         <div class="row">
                                                           <!--  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                     <div class="form-group">
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4">Test Result</label>
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon">
                                                                                    <i class="fa fa-language"></i>
...
<label class="control-label col-md-4">Siblings Registered as Same CNIC:</label>
    <!--Table head-->
    <thead>
        <tr>
            <th>#</th>
                                        ...
                                        <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <div class="input-icon right">
                                                                                    <i class="fa"></i>
                                                                                    <input type="text" id="reg"  minlength="1" maxlength="4" name="phone" class="form-control" data-validation="number" value="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <div class="input-icon right">
                                                                                    <i class="fa"></i>
                                                                                    <input type="text" minlength="1" maxlength="4" id="class" name="mobile" data-validation="number" class="form-control" placeholder="" value="">
                                                                                </div>
                                                                                <div class="help-block">
                                                         ...
                                                         <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-7"><u><strong>Undertaking</u></strong></label>
                                                                        <div class="col-md-12">
                                                                            <div class="input-group">
                                                                                <!-- <span class="input-group-addon">
                                                                                    <i class="fa fa-flag"></i>
                                                        ...
                                                        <div class="row">
                                                           <!--  <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-12">
                                                                     <div class="form-group">
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-11" style="text-decoration: overline;">Parent Signature</label>
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
    ...
    // });
     $("#name").keypress(function(event){
      ...
      $('#phone').on('keypress', function(key) {
        ...
        $('#reg').on('keypress', function(key) {
        if(key.charCode < 48 || key.charCode > 57) {
            return false;
        }
    });
          $('#class').on('keypress', function(key) {
        if(key.charCode < 48 || key.charCode > 57) {
            return false;
        }
    });
