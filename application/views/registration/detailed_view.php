...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo SURL. 'assets/global/plugins/font-awesome/css/font-awesome.min.css'?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SURL. 'assets/global/plugins/simple-line-icons/simple-line-icons.min.css'?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SURL. 'assets/global/plugins/bootstrap/css/bootstrap.min.css'?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SURL. 'assets/global/plugins/uniform/css/uniform.default.css'?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SURL. 'assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css'?>" rel="stylesheet" type="text/css" />
        <!-- END GLOBAL MANDATORY STYLES -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <link href="<?php echo SURL. 'assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css'?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SURL. 'assets/global/plugins/morris/morris.css'?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SURL. 'assets/global/plugins/fullcalendar/fullcalendar.min.css'?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SURL. 'assets/global/plugins/jqvmap/jqvmap/jqvmap.css'?>" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL STYLES -->
        <link href="<?php echo SURL. 'assets/global/css/components.min.css'?>" rel="stylesheet" id="style_components" type="text/css" />
        <link href="<?php echo SURL. 'assets/global/css/plugins.min.css'?>" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href="<?php echo SURL. 'assets/layouts/layout/css/layout.min.css'?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SURL. 'assets/layouts/layout/css/themes/darkblue.min.css'?>" rel="stylesheet" type="text/css" id="style_color" />
        <link href="<?php echo SURL. 'assets/layouts/layout/css/custom.min.css'?>" rel="stylesheet" type="text/css" />
  ...
  <option value="a_levels">A Level</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" id="nine">
                                                                    <div class="form-group">
                                                                        <div class="col-md-12">
                                                                            <div class="input-group">
                                                                              <button type="button" data-toggle="collapse" data-target="#demo" name="" value="" class="btn btn-circle btn-secondary btn-sm">Choose group for 9th & 10th class</button>
                                                                              <div class="form-group form-md-radios" id="demo" class="collapse">
                                                ...
                                                <div class="md-radio-list">
                                                    <div class="md-radio">
                                                        ...
                                                        <label for="checkbox112_6">
                                                            ...
                                                            <span class="box"></span> Computer Science </label>
                                                    </div>
                                                    <div class="md-radio">
                                                        ...
                                                        <label for="checkbox112_7">
                                                            <span></span>
                                                            <span class="check"></span>
                                                            <span class="box"></span> Biology </label>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                                                 ...
                                                                 <div class="form-group" id="eleven">
                                                                    <div class="form-group">
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                              <button type="button" name="" data-toggle="collapse" data-target="#demo1" value="" class="btn btn-circle btn-secondary btn-sm ">Choose group for 11th & 12th class</button>
                                                                              <div class="form-group form-md-radios" id="demo1" class="collapse">
                                                <label class="col-md-3 control-label" for="form_control_1"></label>
                                                <div class="col-md-9">
                                                    <div class="md-radio-list">
                                                        <div class="md-radio">
                                                            ...
                                                            <label for="checkbox1_6">
                                                                <span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span>Pre Engineering </label>
                                                        </div>
                                                        <div class="md-radio">
                                                            ...
                                                            <label for="checkbox1_7">
                                                                <span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span> Pre Medical </label>
                                                        </div>
                                                        <div class="md-radio">
                                                            ...
                                                            <label for="checkbox1_611">
                                                                ...
                                                                <span class="box"></span> ICS </label>
                                                                   ...
                                                                   <div class="form-group" id="o_levels">
                                                                    <div class="form-group">
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                              <button type="button" name="" value="" data-toggle="collapse" data-target="#demo2" class="btn btn-circle btn-secondary btn-sm ">Choose Elective group for O's level</button>

                                                                              <div class="form-group form-md-radios" id="demo2" class="collapse">
                                                <label class="col-md-3 control-label" for="form_control_1"></label>
                                                <div class="col-md-9">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        ...
                                                        <label for="checkbox2_8">
                                                            <span></span>
                                                            <span class="check"></span>
                                                            <span class="box"></span> Group A(Science) </label>
                                                    ...
                                                    <div class="md-radio">
                                                        ...
                                                        <label for="checkbox2_9">
                                                            <span></span>
                                                            <span class="check"></span>
                                                            <span class="box"></span> Group B(General) </label>
                                                            <ul style="font-size: 10px;">
                                                                <li>
                                             ...
                                             <div class="form-group form-md-checkboxes" id="demo3" class="collapse">
                                                    ...
                                                    <div class="md-checkbox-list">
                                                        ...
                                                        <div class="md-checkbox">
                                                            ...
                                                            <label for="checkbox1_2">
                                                                <span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span> Mathematics </label>
                                                        </div>
                                                        <div class="md-checkbox">
                                              ...
                                              <button type="button" name="" value="" data-toggle="collapse" data-target="#demo4" class="btn btn-circle btn-secondary btn-sm ">Select Optional Subject for O's level if you want ??</button>
                                                ...
                                                <div class="md-checkbox-list">
                                                    ...
                                                    <div class="md-checkbox">
                                                        ...
                                                        <label for="checkbox2_2">
                                                            <span></span>
                                                            <span class="check"></span>
                                                            <span class="box"></span> Environmental Management </label>
                                                    </div>
                                                    <div class="md-checkbox">
                                                            ...
                                                            <span class="box"></span> Sociology </label>
                                                                   ...
                                                                   <div class="form-group" id="a_levels">
                                                                    <div class="form-group">
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                              <button type="submit" name="" value="" class="btn btn-circle btn-secondary btn-sm ">Choose subjects for A level</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!--  <div class="col-md-6" id="o_levels">
                                                                <div class="form-group">
                                                                    <div class="form-group">
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                              <button type="submit" name="9" value="9" class="btn btn-danger"></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
